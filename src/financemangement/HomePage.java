...
public class HomePage extends javax.swing.JFrame {
    ...
    public void setfields (String accname,int startbal){
        jTextField1.setText(accname);
        String as = String.valueOf(startbal);
        jTextField2.setText(as);
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("available balance");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/financemangement/calcula.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        System.out.println("Cliked on add expence btn");
        this.dispose();
        AddExpence a = new AddExpence();
        a.setVisible(true);
        a.getaccnamestartbal(accname,startbal,password);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        System.out.println("Cliked on add income btn");
        this.dispose();
        AddIncome a = new AddIncome();
        a.setVisible(true);
        a.getaccnamestartbal(accname,startbal,password);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        ViewExpence v = new ViewExpence();
        v.setVisible(true);
        v.getaccnamestartbal(accname,startbal,password);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        this.dispose();
        ViewIncome d = new ViewIncome();
        d.setVisible(true);
        d.getaccnamestartbalinc(accname,startbal,password);
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if(evt.getSource() == jButton7){
         this.dispose();
        CalculationPage v = new CalculationPage();
        v.setVisible(true);
        v.getaccnamestartbal(accname,startbal,password);
        }
    }//GEN-LAST:event_jButton7ActionPerformed

    public void getaccnameandbal(String username,String password,int startbal){
        System.out.println("came to getting function");
        this.accname = username;
        this.password = password;
        this.startbal = startbal;
        System.out.println(accname + password + startbal);
        setfields(accname,startbal);
    }
    /**
